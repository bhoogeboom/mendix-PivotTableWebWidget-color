...
public class SalesOrderImportRow
{
	 ...
	 */
	public static final java.lang.String entityName = "MyFirstModule.SalesOrderImportRow";
	...
	public enum MemberNames
	{
		...
		SalesOrderImportRow_SalesOrderImport("MyFirstModule.SalesOrderImportRow_SalesOrderImport");
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "MyFirstModule.SalesOrderImportRow"));
	}
	...
	protected SalesOrderImportRow(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject salesOrderImportRowMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("MyFirstModule.SalesOrderImportRow", salesOrderImportRowMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MyFirstModule.SalesOrderImportRow");
	...
	public static myfirstmodule.proxies.SalesOrderImportRow initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return myfirstmodule.proxies.SalesOrderImportRow.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static myfirstmodule.proxies.SalesOrderImportRow initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new myfirstmodule.proxies.SalesOrderImportRow(context, mendixObject);
	}

	public static myfirstmodule.proxies.SalesOrderImportRow load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return myfirstmodule.proxies.SalesOrderImportRow.initialize(context, mendixObject);
	}

	public static java.util.List<myfirstmodule.proxies.SalesOrderImportRow> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<myfirstmodule.proxies.SalesOrderImportRow> result = new java.util.ArrayList<myfirstmodule.proxies.SalesOrderImportRow>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//MyFirstModule.SalesOrderImportRow" + xpathConstraint))
			result.add(myfirstmodule.proxies.SalesOrderImportRow.initialize(context, obj));
		return result;
	}
	 ...
	 */
	public final myfirstmodule.proxies.SalesOrderImport getSalesOrderImportRow_SalesOrderImport() throws com.mendix.core.CoreException
	{
	 ...
	 * @return value of SalesOrderImportRow_SalesOrderImport
	 */
	public final myfirstmodule.proxies.SalesOrderImport getSalesOrderImportRow_SalesOrderImport(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		myfirstmodule.proxies.SalesOrderImport result = null;
		...
		if (identifier != null)
			result = myfirstmodule.proxies.SalesOrderImport.load(context, identifier);
		return result;
	}
	 ...
	 */
	public final void setSalesOrderImportRow_SalesOrderImport(myfirstmodule.proxies.SalesOrderImport salesorderimportrow_salesorderimport)
	{
	 ...
	 * @param salesorderimportrow_salesorderimport
	 */
	public final void setSalesOrderImportRow_SalesOrderImport(com.mendix.systemwideinterfaces.core.IContext context, myfirstmodule.proxies.SalesOrderImport salesorderimportrow_salesorderimport)
	{
	...
	public boolean equals(Object obj)
	{
		...
		{
			final myfirstmodule.proxies.SalesOrderImportRow that = (myfirstmodule.proxies.SalesOrderImportRow) obj;
	...
	{
		return "MyFirstModule.SalesOrderImportRow";
	}
